...
TempFileName = %A_Temp%\Work-auto.ahk
...
, %TempFileName%
;MsgBox %TempFileName%
;Run "\\acsnfs4.ucsd.edu\unix-home\linux\cogsci\oce\01\jennekin\Programs\AutoHotkey104805\AutoHotkey.exe" %TempFileName%
Run %TempFileName%